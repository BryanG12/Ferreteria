      ...
      <div className="container-fluid page-body-wrapper">
        ...
        <div className="main-panel">
          <div className="content-wrapper">
            <div>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nihil soluta, fuga assumenda ea voluptates officia sapiente! Dolorem numquam beatae optio facilis laudantium, assumenda sunt placeat, tempore voluptatem amet repellendus illum!</div>
          </div>
